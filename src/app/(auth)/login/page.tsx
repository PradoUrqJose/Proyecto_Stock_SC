    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4">
      <Card className="w-full max-w-md border-[#dddddd] shadow-sm">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-2xl font-medium text-[#181d26]">Mercadería</CardTitle>
          <p className="text-sm text-[#41454d]">Inicia sesión para continuar</p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" disabled={loading} className="w-full bg-[#181d26] hover:bg-[#0d1218] text-white rounded-lg">
              {loading ? (
                <>
            ...
            <p className="text-xs text-[#41454d] text-center">Contacta al administrador para obtener acceso.</p>
          </form>
        </CardContent>
      </Card>
    </div>
